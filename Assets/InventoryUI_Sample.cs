...
public class InventoryUI_Sample : MonoBehaviour
{
    public Transform listParent;
    public InventoryItem_Sample posItem;
    public int maxWidthCount = 10;
    public int inventoryCount = 30;
    public float lineHeight = 100f;

    public List<InventoryItem_Sample> posItems = new List<InventoryItem_Sample>();
    ...
    void InitInventoryPos()
    {
        ...
        for (int index = 0; index < inventoryCount; index++) // 세로 인덱스. 
        {
            ...
            InventoryItem_Sample item = (Instantiate(posItem, transform));
    ...
    InventoryItem_Sample previousHover;
}
